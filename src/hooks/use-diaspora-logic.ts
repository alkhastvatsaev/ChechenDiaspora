...
const sampleExperts: Member[] = [
  ...
  { id: 'S20', prenom: "Марина", nom: "И.", profession: "Социальный наставник", isSocialHelper: true, vouchCount: 56, ville: "Страсбург", pays: "Франция", village: "Гехи", teip: "Гехой", lat: 48.5839, lng: 7.7455, isLive: true, approved: true, message: "Помощь с оформлением документов (Asile, CAF, CPAM)." },
  { id: 'S21', prenom: "Зарема", nom: "Л.", profession: "Административный эксперт", isSocialHelper: true, vouchCount: 42, ville: "Париж", pays: "Франция", village: "Ведено", teip: "Белтой", lat: 48.8566, lng: 2.3522, isLive: true, approved: true, message: "Сопровождение новых семей." },
  ...
  { id: 'S31', prenom: "Магомед", nom: "Т.", profession: "Юрист (Бизнес / Налоги)", isSocialHelper: true, vouchCount: 15, ville: "Лион", pays: "Франция", village: "Аргун", teip: "Мержой", lat: 45.7640, lng: 4.8357, isLive: true, approved: true },
  { id: 'S32', prenom: "Адам", nom: "Ш.", profession: "Присяжный переводчик (FR/RU/CH)", isTranslator: true, vouchCount: 34, ville: "Брюссель", pays: "Бельгия", village: "Ачхой-Мартан", teip: "Валорой", lat: 50.8503, lng: 4.3517, isLive: true, approved: true },
  ...
  { id: 'S11', prenom: "Тимур", nom: "Бокаев", profession: "Грузоперевозки / EU", isBusiness: true, businessName: "Bokaev Logistics", businessDescription: "Доставка грузов по всей Европе.", vouchCount: 28, ville: "Брюссель", pays: "Бельгия", village: "Шатой", teip: "Шатой", lat: 50.8503, lng: 4.3517, isLive: true, approved: true },
